...
class _$CategoryModelImpl implements _CategoryModel {
  const _$CategoryModelImpl({
    ...
    @JsonKey(name: 'strCategoryThumb') required this.thumbUrl,
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, thumbUrl: $thumbUrl, description: $description)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, thumbUrl, description);
...
abstract class _CategoryModel implements CategoryModel {
  const factory _CategoryModel({
    ...
    @JsonKey(name: 'strCategoryThumb') required final String thumbUrl,
